...
const introduction = {
  text: [
    "Hello there, I'm P4rth Sinha (:",

    "I am a student residing in the renowned city of Oxford, United Kingdom, and embarking on a journey to pursue a career in junior development. My ambition is to provide the highest quality CRM support and collaborate with talented individuals to develop outstanding projects.",

    "If I'm not working on coding, you can usually find me out on the football field with my buddies. Football isn't just a game for me, it's a great way to chill out and get some exercise.",

    "I am here to network with developers, innovators, and tech gurus. If you share my enthusiasm for web development and customer relationship management (CRM) support, let's work together to create something incredible.",
  ],
};
